    ...
    <div className="wrapper clear">
      <div style={{ display: 'none' }} className="overlay">
        ...
        <div className="drawer">
          <h2 className="d-flex  justify-between mb-30">Корзина <img className="removeBtn cu-p" src="/img/btn-remove.svg" alt="Remove" />
          </h2>

          <div className="items">

            <div className="cartItem d-flex align-center mb-20">
              <div style={{ backgroundImage: 'url(/img/snickers/1.jpg)' }}
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          ...
          <div className="card">
            <img width={133} height={112} src="/img/snickers/2.jpg" alt="Snickers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/snickers/3.jpg" alt="Snickers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/snickers/4.jpg" alt="Snickers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
